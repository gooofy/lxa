...
makeproto ASM ULONG CompStrlenF(UBYTE * fstring __asm("a0"), RAWARG args __asm("a1"))
{
...
makeproto ASM VOID DoSPrintF(UBYTE * buffer __asm("a0"), UBYTE * fstring __asm("a1"), RAWARG args __asm("a2"))
{
