...
{
    DPRINTF (LOG_DEBUG, "_input: WARNING: InitDev() unimplemented STUB called.\n");
    return dev;
}
...
{                               //                               offset
    ...
    &__g_lxa_input_EndResident, // APTR  rt_EndSkip;                  6
    RTF_AUTOINIT,               // UBYTE rt_Flags;                    7
    VERSION,                    // UBYTE rt_Version;                  8
    NT_DEVICE,                  // UBYTE rt_Type;                     9
    0,                          // BYTE  rt_Pri;                     10
    &_g_input_ExDevName[0],     // char  *rt_Name;                   14
    &_g_input_ExDevID[0],       // char  *rt_IdString;               18
    &__g_lxa_input_InitTab      // APTR  rt_Init;                    22
};
...
struct InitTable __g_lxa_input_InitTab =
{
    ...
    (APTR              *) &__g_lxa_input_FuncTab[0],  // FunctionTable
    (APTR)                &__g_lxa_input_DataTab,     // DataTable
    (APTR)                __g_lxa_input_InitDev       // InitLibFn
};
